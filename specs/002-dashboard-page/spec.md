...
- **FR-016**: The dashboard MUST be reachable only by an authenticated studio session; unauthenticated requests MUST be redirected through the existing login / select-staff flow before the dashboard renders.

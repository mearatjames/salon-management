...
Stand up the Tang Nails repository as a runnable, conventional Next.js 15 project: generate the
...
**Primary Dependencies**: Next.js 15 (App Router, RSC + Server Actions), React 19, Tailwind CSS v4,
...
**Structure Decision**: Single Next.js 15 web application with the App Router at the repository

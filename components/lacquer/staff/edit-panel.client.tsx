...
export function EditPanel({ viewer, target, isLastOwner }: EditPanelProps) {
  ...
  return (
    ...
    {!perms.canEditAnyField ? (
      ...
      >
        <AlertDescription>
          Only owners can edit owner accounts.
        </AlertDescription>
      </Alert>
    ) : null}
    <form
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", minWidth: 0 }}>
          ...
          >
            ...
            {STAFF_COLOR_OPTIONS.find((o) => o.token === draft.color_token)
              ?.label ?? "Color"}
          </span>
        </div>
      </header>
      ...
      <div style={fieldStyle}>
        ...
        <select
          ...
          value={draft.role}
          onChange={(e) =>
            setDraft((d) => ({ ...d, role: e.target.value as StudioRole }))
          }
      ...
      <div style={fieldStyle}>
        ...
        <ColorPicker
          ...
          onChange={(token) =>
            setDraft((d) => ({ ...d, color_token: token }))
          }

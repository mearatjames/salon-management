...
UM.Receipt     = mkIcon(<><path d="M4 2v20l2.5-1.5L9 22l2.5-1.5L14 22l2.5-1.5L19 22l1-.6V2z"/><line x1="8" y1="8" x2="16" y2="8"/><line x1="8" y1="12" x2="16" y2="12"/><line x1="8" y1="16" x2="13" y2="16"/></>);
...
// ── App Sidebar ───────────────────────────────────────────────────────────
function UMSidebar({ active = 'transactions' }) {
  ...
  const workspace = [
    ...
    { id: 'transactions', label: 'Transactions', icon: <UM.Receipt />,    href: '../transaction/Transactions.html' },
  ...
  const ops = [
    ...
    { id: 'report',   label: 'Report',           icon: <UM.FileBar />, href: '../transaction/Day Report.html' },
    { id: 'settings', label: 'Settings',         icon: <UM.Settings />, href: '../user-management/User Management.html' },
  ];

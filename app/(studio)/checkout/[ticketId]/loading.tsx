...
// is therefore structurally identical to `app/(studio)/checkout/loading.tsx`:
// the `.checkout-header` band, the `.checkout-tech-band` row, and the
// two-column `.checkout-body` (catalog + cart columns).
//
    ...
    <div className="checkout-shell" aria-hidden="true">
      ...
      <div className="checkout-body">
        ...
        <section className="checkout-cart" aria-label="Cart">
          ...
          {/* Cart line list placeholder — existing ticket may have items */}
